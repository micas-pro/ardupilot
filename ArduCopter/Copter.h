...
#include <AC_AttitudeControl/AC_AttitudeControl_GPC.h> // GPC Attitude Controller
...
#else
    //#define AC_AttitudeControl_t AC_AttitudeControl_Dual
...
# include USERHOOK_VARIABLES
    ...
    AC_AttitudeControl_GPC *gpc_attitude_control;
